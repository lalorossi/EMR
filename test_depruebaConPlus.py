...
def Tarjeta():
	...
	assert azul.getSaldo() == -2.75
	assert amarillo.getSaldo() == 224.25
	assert naranja.getSaldo() == -2.75
	assert violeta.getSaldo() == 454.25
	...
	assert len(azul.getViajesRealizados()) == 2
	assert len(amarillo.getViajesRealizados()) == 2
	assert len(naranja.getViajesRealizados()) == 2
	...
	assert azul.getSaldo() == -2.75
	assert amarillo.getSaldo() == 218.50
	assert naranja.getSaldo() == -2.75
	assert violeta.getSaldo() == 451.35
